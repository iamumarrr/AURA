    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-brand text-dark-main hover:bg-brand-light": variant === "default",
            "border border-brand text-brand hover:bg-brand/10": variant === "outline",
            "hover:bg-dark-soft text-white": variant === "ghost",
